...
<!--- Added by: Chris - Aug 8, 2013 --->

	<cffunction name="pageReplaceHTMLAttr" access="public" output="false" hint="Replace the HTML content of the specified element">
		<cfargument name="selector" type="string" required="true" hint="The class or ID of the content you wish to insert HTML into" />
		<cfargument name="attribute" type="string" required="true" hint="The attribute name of the content you wish to insert data into" />
		<cfargument name="content" type="string" required="false" hint="HTML to replace with" />
		<cfargument name="partial" type="string" required="false" hint="Partial file containing the HTML you wish to replace with" />
		...
		<cfset loc.resultHTML = "$('#arguments.selector#').attr('#arguments.attribute#', '#loc.HTMLContent#');">
